...
<div
    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        <div>Select some cells and press 'next' to simulate next generation</div>
        <div class="grid grid-cols-3 gap-1 text-center py-2">
            <a href="{{route('reset')}}">
        ...
        <div class="text-sm py-3 text-center">
            <a href="https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life" target="_blank">About Game of Life</a>
        </div>
    </div>
</div>
</body>
